...
<section class="tournament-phase">
  ...
  <p class="subtitle">Pick winners quickly and surface your top priority first.</p>
  ...
  {:else}
    <p class="preparing-text">Preparing next round...</p>
  {/if}
